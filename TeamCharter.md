...
- Team Coordinator/Project Manager: Sid
- Tech Ops: Quentin
- Asset sourcing? Koki? (pictures, embeds, etc)

> [!IMPORTANT]
> Text that has been put into a callout are suggested additions. Text that has been struckthrough are suggested removals. This callout won't be in the final charter and just exists for collaboration purposes.
...
> [!NOTE]
> This removal is due to migrating this portion down to the section regarding Team Agreements. A corresponding addition callout is down there.
...
> [!NOTE]
> For this section on our team we should list out our strengths and weaknesses and maybe also some introductory text about the team member?
...
~~- Accountability~~
~~- Cooperation~~
~~**Group Norms: (see meeting schedule)**~~
~~- Check in before large changes~~
~~- Ask for help if needed (and ASAP)~~
~~- ~~
~~**Metrics of Success:**~~
~~- Collaboration - Sharing work evenly and making use of everyone's strengths~~
~~- Sense of shared achievement~~
...
~~**Milestones: (to be decided later, project finished by march 17)~~
~~**User stories: (to be decided later)~~
...
- Discord is out preferred medium for communications outside meetings.
...
~~**Team Procedure**~~
~~1. We plan to revise these agreements when we have a clearer sense of the work we'll be doing together.~~
  ~~- Every meeting we will have a chance to revise this agreement.~~
~~2. Accountability~~
  ~~- We will inform the group immediately when we suspect that we might miss a deadline we agreed to.~~
    ~~- We will not wait until we are already late!~~
~~3. The moment we suspect that we might not make a deadline we will inform the group so that we may plan around it.~~
  ~~- We will be meeting on Fridays, so we’ll make our best effort to complete assigned tasks by Thursday, and come prepared to discuss it and work through it together if we hit a snag.~~
~~4. Conflict Resolution~~
  ~~- If we find ourselves unable to come to agreement on some issue, we will decide by majority vote.~~
~~5. We will discuss conflicts with Poul before voting, he may be able to offer insight or technical reasons to prefer one choice over another.~~
~~6. Git procedure~~
